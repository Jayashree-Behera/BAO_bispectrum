...
sys.path.append("global/u1/s/shreeb/Project1/slurm")
...
kg,bg,bgn,cov,scaled_cov,_ = cutslice(0.005,0.3,kk,bkm,bk,bknm,bkn,bk_mol)
...
if __name__=="__main__":
    ...
    args.add_argument("--filepaths",default = os.path.join("data","camb_python"))
    ...
    for file in os.listdir(filepaths):
        if file[-3:] == "dat" and file.endswith(f"{parsed_args.index:04}.dat"):
            ...
            output_path = "/global/u1/s/shreeb/Project1/nobao_project/mcmc_results/mcmc_" + Path(filepath).stem + ".h5"
