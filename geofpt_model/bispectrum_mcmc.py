...
def model(kk,*args):
    ...
    res = Bi_wiggle(alpha*kk,pk1,pk2,pk3,pkn1,pkn2,pkn3,f,b1,b2,S0,S1, "GEO")      #*Bi0(kk,pkn11,pkn12,pkn13,f,b1,b2,S0,S1)
    return res

if __name__=="__main__":
    args = argparse.ArgumentParser()
    args.add_argument("--config",default=os.path.join("../my_utils","mcmc_params.yaml"))
    args.add_argument("--filepath",default = "/pscratch/sd/s/shreeb/shreeb/BAO_Bispectrum_with_data/nobao_project/data/camb_new/camb_python/camb_67773070_matterpower_z0.5_0060.dat")
    ...
    output_path = "/global/homes/s/shreeb/BAO_bispectrum/geofpt_model/fid_fits/mcmc_"+ Path(parsed_args.filepath).stem + ".h5"
